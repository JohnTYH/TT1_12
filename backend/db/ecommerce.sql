...
-- Dumping data for table ecommerce.customer: ~5 rows (approximately)
...
-- Dumping data for table ecommerce.order: ~1 rows (approximately)
...
-- Dumping structure for table ecommerce.order_item
...
-- Dumping data for table ecommerce.order_item: ~1 rows (approximately)
/*!40000 ALTER TABLE `order_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_item` ENABLE KEYS */;


-- Dumping data for table ecommerce.product: ~20 rows (approximately)
